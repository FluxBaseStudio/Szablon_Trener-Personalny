...
export default function TrainerLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-950 font-sans selection:bg-amber-400 selection:text-black overflow-x-hidden animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-[fadeIn_0.2s_ease-out]">
          <div className="bg-white border-4 border-black max-w-lg w-full shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1">
              {/* Product Summary */}
              {selectedPlan ? (
                <div className="border-2 border-black p-4 bg-zinc-50 flex justify-between items-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  <div>
                    <p className="font-black uppercase text-sm tracking-tight">{selectedPlan.name}</p>
                    <p className="text-zinc-500 text-xs uppercase font-bold mt-0.5">{selectedPlan.desc}</p>
                  </div>
                  <span className="font-black text-lg text-right whitespace-nowrap pl-4">{selectedPlan.price}</span>
                </div>
              ) : (
                <div className="border-2 border-black p-4 bg-zinc-50 text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  <p className="font-black uppercase text-sm tracking-tight text-zinc-500">Brak wybranego planu. Wybierz pakiet z cennika.</p>
                </div>
              )}
              ...
              <div className="border-2 border-black p-4 bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-black uppercase tracking-wide mb-1 text-zinc-700">Imię i Nazwisko</label>
                    <input 
                      type="text" 
                      name="fullName"
                      ...
                      className="w-full bg-zinc-50 border-2 border-black p-2.5 text-sm font-bold uppercase focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all placeholder:text-zinc-400"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-black uppercase tracking-wide mb-1 text-zinc-700">Adres E-mail</label>
                    <input 
                      type="email" 
                      name="email"
                      ...
                      className="w-full bg-zinc-50 border-2 border-black p-2.5 text-sm font-bold focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-400 transition-all placeholder:text-zinc-400"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-black uppercase tracking-wide mb-1 text-zinc-700">Numer Telefonu</label>
                    <input 
                      type="tel" 
                      name="phone"
              ...
              <div className="bg-zinc-100 p-4 border-2 border-dashed border-zinc-400 text-xs font-semibold uppercase tracking-wider text-zinc-600 space-y-1.5">
            ...
            {/* MODAL FOOTER WITH FINAL ACTION AND EXIT BUTTON */}
            <div className="p-6 border-t-4 border-black bg-zinc-50 space-y-3">
              <button 
              ...
              <button 
                onClick={() => setCartOpen(false)}
                className="w-full bg-white text-black font-black uppercase tracking-wider py-2.5 border-2 border-black hover:bg-zinc-200 transition-all text-xs"
              >
      ...
      <header className="grid grid-cols-1 lg:grid-cols-12 border-b-4 border-black min-h-[calc(100vh-80px)]">
        <div className="lg:col-span-7 flex flex-col justify-center p-6 md:p-12 lg:p-20 bg-white opacity-0 animate-slide-up">
          ...
          <p className="text-lg md:text-xl font-medium max-w-xl text-zinc-700 mb-10 leading-relaxed border-l-4 border-black pl-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="#metody" className="bg-white text-black text-center font-bold uppercase tracking-wider px-8 py-4 border-4 border-black hover:bg-zinc-900 hover:text-white transition-colors duration-200">Moja Metodyka</a>
          </div>
        </div>
        <div className="lg:col-span-5 bg-zinc-200 border-t-4 lg:border-t-0 lg:border-l-4 border-black relative min-h-[400px] lg:min-h-auto overflow-hidden">
      ...
      {/* TICKER */}
      <div className="bg-amber-400 border-b-4 border-black py-3 overflow-hidden select-none">
        <div className="animate-marquee whitespace-nowrap text-black font-black uppercase tracking-widest text-sm">
          {" • CIĘŻARY • DIETA • DYSCYPLINA • BRAK WYMÓWEK • NAUKA ".repeat(10)}
        </div>
      </div>
      ...
      <section className="bg-black text-white border-b-4 border-black grid grid-cols-2 md:grid-cols-4 divide-y-4 md:divide-y-0 md:divide-x-4 divide-white text-center">
        <div className="p-8 hover:bg-zinc-900 transition-colors"><p className="text-4xl md:text-6xl font-black text-amber-400"><Counter target="120" suffix="+" /></p><p className="text-xs md:text-sm font-bold uppercase tracking-widest text-zinc-400 mt-2">Metamorfoz</p></div>
        <div className="p-8 hover:bg-zinc-900 transition-colors"><p className="text-4xl md:text-6xl font-black text-amber-400"><Counter target="8" suffix=" lat" /></p><p className="text-xs md:text-sm font-bold uppercase tracking-widest text-zinc-400 mt-2">Doświadczenia</p></div>
        <div className="p-8 hover:bg-zinc-900 transition-colors"><p className="text-4xl md:text-6xl font-black text-amber-400"><Counter target="100" suffix="%" /></p><p className="text-xs md:text-sm font-bold uppercase tracking-widest text-zinc-400 mt-2">Naukowe Podejście</p></div>
        <div className="p-8 hover:bg-zinc-900 transition-colors"><p className="text-4xl md:text-6xl font-black text-amber-400"><Counter target="450" suffix="k+" /></p><p className="text-xs md:text-sm font-bold uppercase tracking-widest text-zinc-400 mt-2">Przerzuconych Ton</p></div>
      </section>
      ...
      <section id="metody" className="p-6 md:p-12 lg:p-20 border-b-4 border-black bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border-4 border-black p-8 bg-zinc-50 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all">
              ...
              <p className="text-zinc-700 font-medium">Koniec z losowym machaniem ciężarami. Twój plan ma precyzyjnie rozpisane makrocykle.</p>
            </div>
            <div className="border-4 border-black p-8 bg-zinc-50 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all">
              ...
              <p className="text-zinc-700 font-medium">Żadnych restrykcyjnych diet. Otrzymujesz wyliczone zapotrzebowanie i strategię suplementacyjną.</p>
            </div>
            <div className="border-4 border-black p-8 bg-zinc-50 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all">
              ...
              <p className="text-zinc-700 font-medium">Co tydzień analizujemy obwody, wagę oraz wideo z wykonaniem kluczowych bojów.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CASE STUDY */}
      <section className="grid grid-cols-1 lg:grid-cols-2 border-b-4 border-black bg-zinc-900 text-white">
        <div className="p-6 md:p-12 lg:p-20 flex flex-col justify-center border-b-4 lg:border-b-0 lg:border-r-4 border-black">
          ...
          <div className="space-y-6 border-l-2 border-zinc-700 pl-6 my-6">
            <div><p className="text-zinc-400 text-xs uppercase tracking-wider">Okres współpracy</p><p className="font-bold text-lg">16 tygodni</p></div>
            <div><p className="text-zinc-400 text-xs uppercase tracking-wider">Waga</p><p className="font-bold text-lg text-amber-400">94 kg → 83 kg (-11 kg)</p></div>
          </div>
          <blockquote className="bg-zinc-800 p-6 border-2 border-amber-400 font-medium italic text-zinc-300">
        ...
        <div className="bg-zinc-800 relative grid grid-cols-2 divide-x-4 divide-black h-[400px] lg:h-auto overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div className="border-4 border-black bg-white p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all flex flex-col justify-between">
            <div>
              ...
              <p className="text-zinc-500 text-xs font-bold uppercase mt-1">Współpraca zdalna 100%</p>
              <div className="text-5xl font-black my-6 border-b-4 border-black pb-4">399 PLN <span className="text-sm font-bold text-zinc-500 uppercase tracking-wider">/ msc</span></div>
              
              <table className="w-full text-left text-xs uppercase font-bold tracking-wide mb-8 divide-y-2 divide-black">
                <tbody>
                  <tr><td className="py-2.5 text-zinc-600">Plan treningowy</td><td className="py-2.5 text-right">Indywidualny</td></tr>
                  <tr><td className="py-2.5 text-zinc-600">Rozpiska makro</td><td className="py-2.5 text-right">Tak</td></tr>
                  <tr><td className="py-2.5 text-zinc-600">Raporty wideo</td><td className="py-2.5 text-right">Co tydzień</td></tr>
                  <tr><td className="py-2.5 text-zinc-600">Kontakt z trenerem</td><td className="py-2.5 text-right">Czat / Aplikacja</td></tr>
                  <tr><td className="py-2.5 text-zinc-600">Medyczne konsultacje</td><td className="py-2.5 text-right text-zinc-400">Brak</td></tr>
                </tbody>
              </table>
            </div>
          ...
          {/* CARD 2: HYBRID ELITE */}
          <div className="border-4 border-black bg-zinc-950 text-white p-6 md:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all flex flex-col justify-between relative">
            <div>
              ...
              <p className="text-zinc-400 text-xs font-bold uppercase mt-1">Trening personalny + online</p>
              <div className="text-5xl font-black my-6 text-amber-400 border-b-4 border-zinc-800 pb-4">1499 PLN <span className="text-sm font-bold text-zinc-400 uppercase tracking-wider">/ msc</span></div>
              
              <table className="w-full text-left text-xs uppercase font-bold tracking-wide mb-8 divide-y-2 divide-zinc-800">
                <tbody>
                  <tr><td className="py-2.5 text-zinc-400">Plan treningowy</td><td className="py-2.5 text-right text-white">Indywidualny</td></tr>
                  <tr><td className="py-2.5 text-zinc-400">Treningi 1-na-1</td><td className="py-2.5 text-right text-amber-400">8 sesji / msc</td></tr>
                  <tr><td className="py-2.5 text-zinc-400">Rozpiska makro</td><td className="py-2.5 text-right text-white">Pełna suplementacja</td></tr>
                  <tr><td className="py-2.5 text-zinc-400">Kontakt z trenerem</td><td className="py-2.5 text-right text-white">Priorytet 24/7</td></tr>
                  <tr><td className="py-2.5 text-zinc-400">Analiza badań krwi</td><td className="py-2.5 text-right text-amber-400">Tak (Co kwartał)</td></tr>
                </tbody>
              </table>
            </div>
      ...
      <footer className="bg-black text-white p-8 md:p-12 border-t-4 border-black flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          ...
          <p className="text-zinc-500 text-xs uppercase tracking-wider mt-1">© 2026 Wszelkie prawa zastrzeżone. Projekt wdrożony na infrastrukturze FluxBase.</p>
        </div>
        <div className="flex gap-6 text-sm font-bold uppercase tracking-wider">
          <span className="text-zinc-400">warszawa, Polska</span>
